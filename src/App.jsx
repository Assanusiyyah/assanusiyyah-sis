...
function ClinicModule({students, staff, clinic, setClinic, currentUser, settings}){
  ...
  var SYMPTOMS = [
    "Headache","Fever / Pyrexia","Malaria symptoms","Stomach ache / Abdominal pain",
    "Vomiting / Nausea","Diarrhoea","Menstrual pain / Dysmenorrhoea","Eye infection / Conjunctivitis",
    "Toothache / Dental pain","Skin rash / Dermatitis","Injury / Wound / Laceration",
    "Asthma attack / Difficulty breathing","Sickle cell crisis","Fainting / Syncope",
    "Cough / Cold / URTI","Ear pain / Otitis","Back pain","Anxiety / Stress / Emotional distress",
    "Urinary tract infection","Typhoid symptoms","Food poisoning","Hypertension symptoms",
    "Allergic reaction","Nose bleed / Epistaxis","Muscle cramps / Body pain","Others"
  ];
